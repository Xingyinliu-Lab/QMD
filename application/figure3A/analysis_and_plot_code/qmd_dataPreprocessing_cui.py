...
def preprocess_qmd(predix,datafilename, minimum_taxa_detection_num, control_label, treat_label, group_label, permu_loops, minimum_taxa_abundance_control, manner):
    # print(manner)
    ...
    genuslist = genuslist.reset_index(drop=True)
    genuslist.to_csv(predix+'_taxa_Into_Model.csv')
